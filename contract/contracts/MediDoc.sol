...
contract MediDocContract {
    ...
    // state variables
    // map (wallet_address -> map(file_CID -> Document))
    ...
    function addDocument(
        ...
        Document memory doc = Document(
            fileName, fileCID, fileHash, ownerAddress, State.Unverified, block.timestamp
        );
        user_documents[ownerAddress][fileCID] = doc;
